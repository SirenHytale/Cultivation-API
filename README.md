...
| Add a cosmetic label players wear beside their name | `registerTitle` | [Registries](docs/registries.md#titles) |
| Gate, or react to, the end of the ladder | `onPreAscension`, `onAscension` | [Driving progression](docs/driving-progression.md#the-end-of-the-ladder-ascension) |
...
**colors**. The third, `ProgressionProvider`, lets your mod own levelling
